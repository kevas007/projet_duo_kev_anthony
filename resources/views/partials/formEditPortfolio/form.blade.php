    ...
    <div class="container">
        <form action="/portfolio/{{$edit->id}}/update" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{$edit->paragraphe}}" name="h4_1_service" class="form-control" id="exampleInputEmail1"
                    aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">age</label>
                <input type="text" value="{{$edit->img}}" name="p1_service" class="form-control" id="exampleInputEmail1"
                    aria-describedby="emailHelp">
            </div>
